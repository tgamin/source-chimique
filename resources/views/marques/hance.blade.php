...
@section('content')
    ...
    <section id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active hero-image"
                style="background-image: url('/img/bg-7.jpg'); height: 750px;">
    ...
    <section class="left-img container d-flex">
        <div class="img-container col-md-6">
            <img class="sec-img" src="/img/hance.png" alt="">
        </div>
        <div class="col-md-6">
            <h1 class="section-title">Hance offre une gamme exceptionnelle de détergents</h1>
            <div class="paragraph-container">
                <p class="paragraph">
                    Hance offre une gamme exceptionnelle de détergents spécialement élaborés pour répondre aux exigences
                    des clients en matière de produits de nettoyage et d'hygiène.
                </p>

                <p class="paragraph">
                    Les produits Hance sont conçus pour garantir une efficacité maximale, que vous ayez besoin de
                    nettoyer vos vêtements, votre maison et votre vaisselle.
                </p>
            </div>
            <a class="section-link" href="https://hance.ma/">www.hance.ma</a>
        </div>
    </section>
