...
@section('content')
    ...
    <section id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active hero-image"
                style="background-image: url('/img/bg-4.jpg'); height: 750px;">
    ...
    <section class="left-img container d-flex">
        <div class="img-container col-md-6">
            <img class="sec-img" src="/img/drem.png" alt="">
        </div>
        <div class="col-md-6">
            <h1 class="section-title">Drem est une marque experte dans la prouction de nettoyant sols
            </h1>
            <div class="paragraph-container">
                <p class="paragraph">
                    Drem est une marque experte dans la prouction de nettoyant sols, déterminée à fournir des solutions
                    de nettoyage efficaces et économiques pour les clients particuliers et les entreprises.
                </p>

                <p class="paragraph">
                    Depuis sa création, la marque s'est imposée comme un leader dans le secteur des produits de
                    nettoyage de sol de haute qualité.
                </p>
            </div>
            <a class="section-link" href="https://drem.ma/">www.drem.ma</a>
        </div>
    </section>
