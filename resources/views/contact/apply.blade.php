        ...
        <div class="container-fluid">
            <div class="row about">
                <div class="offset-1 col-md-5  p-5 ps-0 about-content">
                    <p class="my-3">Consultez l'intégralité de nos offres sur notre page LinkedIn dédiée aux recrutements :  <a href="https://ma.linkedin.com/company/technicfile" target="_blank">LinkedIn - Offres d'emploi.</a></p>
                    <p class="mb-3">Ce formulaire est fait pour vous !</p>
                    <form>
                        <div class="row ">
