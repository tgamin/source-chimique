...
@section('content')
    ...
    <section id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active hero-image"
                style="background-image: url('/img/bg-8.jpg'); height: 750px;">
    ...
    <section class="left-img container d-flex">
        <div class="img-container col-md-6">
            <img class="sec-img" src="/img/lelas.png" alt="">
        </div>
        <div class="col-md-6">
            <h1 class="section-title">Lelas est une marque dédiée à la fabrication de poudres pour le lavage à la main
                et en machine

            </h1>
            <div class="paragraph-container">
                <p class="paragraph">
                    Lelas est une marque dédiée à la fabrication de poudres pour le lavage à la main et en machine
                    automatique, se caractérisant par des normes de qualité strictes et une composition qui éradique
                    efficacement les taches tenaces tout en préservant les couleurs.
                </p>

            </div>
            <a class="section-link" href="https://lelas.ma/">www.lelas.ma</a>
        </div>
    </section>
